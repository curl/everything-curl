...
## C
 ...
 - connection cache: [Persistent connections](usingcurl-persist.md#persistent-connections), [Connection reuse](libcurl-connectionreuse.md#connection-reuse), [Sharing between easy handles](libcurl-sharing.md#sharing-between-easy-handles)
...
## L
 ...
 - libcurl version: [The latest version?](building.md#the-latest-version?), [Available exit codes](usingcurl-returns.md#available-exit-codes), [Which libcurl version](libcurl-api.md#which-libcurl-version)
