...
## H
 ...
 - Header callback: [Header callback](callback-header.md#header-callback), [HTTP responses](libcurl-http.md#http-responses)
...
## R
 - ranges: [Numerical ranges](cmdline-globbing.md#numerical-ranges), [Alphabetical ranges](cmdline-globbing.md#alphabetical-ranges), [Combinations](cmdline-globbing.md#combinations), [Resuming and ranges](usingcurl-downloads.md#resuming-and-ranges), [Ranges](http.md#ranges), [HTTP response code](libcurl-http.md#http-response-code), [About HTTP response code "errors"](libcurl-http.md#about-http-response-code-"errors")
...
## S
 ...
 - SSH: [List of all exit codes](usingcurl-returns.md#list-of-all-exit-codes), [SCP and SFTP](usingcurl-scpsftp.md#scp-and-sftp), [Known hosts](usingcurl-scpsftp.md#known-hosts), [SSH key callback](callback-sshkey.md#ssh-key-callback), [Trace everything](libcurl-verbose.md#trace-everything)
...
## W
 - Write callback: [Write callback](callback-write.md#write-callback), [HTTP responses](libcurl-http.md#http-responses)
