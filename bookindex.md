...
## C
 ...
 - CURLOPT_URL: [Easy handle](libcurl-easyhandle.md#easy-handle), [curl --libcurl](libcurl--libcurl.md#curl---libcurl), [Set handle options](libcurl-options.md#set-handle-options), [HTTP Download](libcurl-http.md#http-download)
...
## F
 ...
 - --ftp-method: [--ftp-method](usingcurl-ftp.md#ftp-method), [multicwd](usingcurl-ftp.md#multicwd), [nocwd](usingcurl-ftp.md#nocwd), [singlecwd](usingcurl-ftp.md#singlecwd)
...
## R
 ...
 - RTSP: [What protocols does curl support?](protocols-protocols.md#what-protocols-does-curl-support?), [Supported protocols](usingcurl.md#supported-protocols), [RTSP interleave callback](libcurl-callbacks.md#rtsp-interleave-callback)
## S
 ...
 - SMTPS: [What protocols does curl support?](protocols-protocols.md#what-protocols-does-curl-support?), [Supported protocols](usingcurl.md#supported-protocols), [Protocols allowing upload](usingcurl-uploads.md#protocols-allowing-upload)
...
## U
 - -u: [Passwords and snooping](cmdline-passwords.md#passwords-and-snooping), [Command line leakage](cmdline-passwords.md#command-line-leakage), [URLs](usingcurl-scpsftp.md#urls)
