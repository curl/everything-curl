...
## C
 ...
 - Cookies: [Cookies](http.md#cookies), [HTTP Cookies](libcurl-http.md#http-cookies)
 ...
 - curl_easy_cleanup: [easy handle](libcurl-cleanup.md#easy-handle), [curl --libcurl](libcurl--libcurl.md#curl---libcurl)
...
## H
 ...
 - Header callback: [Header callback](libcurl-callbacks.md#header-callback)
