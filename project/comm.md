...
you. It is about sending emails to an address that then sends that email out
to all the subscribers. Our mailing lists have at most a few thousand
...
is the kind of thing that happens to a project that lives for a long time.
